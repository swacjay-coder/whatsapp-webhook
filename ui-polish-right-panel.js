...
s = s.replace(/const BOT_VERSION = "[^"]*";/, 'const BOT_VERSION = "iconic-team-inbox-v31-5-8-60-3-1-11-unified-functional-sidebar";');
...
if (s !== original) {
  ...
  console.log("Restored V31.5.8.60.3.1.11 unified functional sidebar.");
} else {
  console.log("V31.5.8.60.3.1.11 unified functional sidebar already active.");
}
